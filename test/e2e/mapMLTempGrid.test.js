    ...
    describe(
      ...
      () => {
        beforeAll(async () => {
          ...
          await page.goto(PATH + "mapMLTempGrid.html");
        });
        ...
        test("[" + browserType + "]" + " Tiles load in on default map zoom level", async () => {
          const tiles = await page.$eval(
            "xpath=//html/body/map/div >> css=div > div.leaflet-pane.leaflet-map-pane > div.leaflet-pane.leaflet-overlay-pane > div > div.leaflet-layer.tempGridML > div",
