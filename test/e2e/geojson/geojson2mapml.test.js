...
test.describe('GeoJSON API - geojson2mapml', () => {
  ...
  test('Point Geometry (string json)', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(1)').outerHTML
      );
  ...
  test('Line Geometry', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(2)').innerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('Polygon Geometry', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(3)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('MultiPoint Geometry', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(4)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('MultiLineString Geometry', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(5)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('MultiPolygon Geometry', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(6)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('Geometry Collection', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(7)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('Feature Collection', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(8)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('BBOX, Options label, caption + properties string', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(9)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('BBOX, Options label, caption + properties function', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(10)').outerHTML
      );
    expect(out).toEqual(exp);
  });
  ...
  test('Feature', async () => {
    ...
    const exp = await page
      .locator('#expected')
      .evaluate(
        (node) => node.content.querySelector('layer-:nth-child(11)').outerHTML
      );
    expect(out).toEqual(exp);
  });
